...
#[Group('Driver')]
#[Endpoint('On The Way', 'Mark driver as on the way to pickup location')]
#[Authenticated]
...
#[Response(status: 200, description: 'Driver is on the way to pickup location.')]
final class OnTheWayController extends Controller
{
    ...
    {
        $this->authorize('onTheWay', $ride);

        $this->onTheWay->handle(
            ride: $ride,
            driverId: $user->id,
        );
