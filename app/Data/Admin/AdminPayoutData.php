...
final class AdminPayoutData extends Data
{
    ...
    public static function fromModel(DriverPayout $payout, AvatarUrlService $avatarResolver): self
    {
        $driver = $payout->relationLoaded('driver') ? $payout->driver : null;

        return new self(
            id: $payout->id,
            driver: $driver !== null ? UserData::fromModel($driver, $avatarResolver) : null,
