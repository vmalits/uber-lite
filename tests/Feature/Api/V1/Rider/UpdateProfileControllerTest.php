...
it('successfully updates rider profile', function (): void {
    $response = $this->actingAs($this->user)->putJson('/api/v1/rider/profile', [
        'first_name' => 'Jane',
        'last_name'  => 'Smith',
    ]);
...
it('returns unauthorized without authentication', function (): void {
    $response = $this->putJson('/api/v1/rider/profile', [
        'first_name' => 'Jane',
    ]);
...
it('returns forbidden for driver role', function (): void {
    ...
    $response = $this->actingAs($driver)->putJson('/api/v1/rider/profile', [
        'first_name' => 'Jane',
    ]);
