...
use App\Http\Controllers\Api\V1\Admin\CancelRideController;
...
Route::prefix('admin')
    ...
    ->group(function (): void {
        ...
        Route::get('analytics/real-time', [GetRealTimeAnalyticsController::class, '__invoke'])
            ->middleware(['auth:sanctum', 'role:admin'])
            ->name('api.v1.admin.analytics.realtime');
        ...
        Route::get('export/rides', [ExportRidesController::class, '__invoke'])
            ->middleware(['auth:sanctum', 'role:admin'])
            ->name('api.v1.admin.export.rides');
        ...
        Route::post('rides/{ride}/cancel', [CancelRideController::class, '__invoke'])
            ->middleware(['auth:sanctum', 'role:admin'])
            ->name('api.v1.admin.rides.cancel');
