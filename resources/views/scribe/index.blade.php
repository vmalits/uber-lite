...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="rider">
                    ...
                    <ul id="tocify-header-safety" class="tocify-header">
                <li class="tocify-item level-1" data-unique="safety">
...
Must be one of:
<ul style="list-style-type: square;"><li><code>scheduled</code></li> <li><code>pending</code></li> <li><code>accepted</code></li> <li><code>on_the_way</code></li> <li><code>arrived</code></li> <li><code>started</code></li> <li><code>completed</code></li> <li><code>cancelled</code></li></ul>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>filter</code></b>&nbsp;&nbsp;
<small>object</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/admin/tickets?per_page=20&amp;status=open&amp;filter[user_id]=01HZY1K8QK8ZQ2V6J8F4K8Q2V6&amp;filter[subject]=Issue+with+ride&amp;sort=-created_at" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
const params = {
    "per_page": "20",
    "status": "open",
    "filter[user_id]": "01HZY1K8QK8ZQ2V6J8F4K8Q2V6",
    "filter[subject]": "Issue with ride",
    "sort": "-created_at",
};
Object.keys(params)
    .forEach(key =&gt; url.searchParams.append(key, params[key]));
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/admin/tickets';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-admin-tickets">
            <blockquote>
            <p>Example response (200, Paginated support tickets list retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-admin-tickets" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-tickets"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-tickets"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-tickets" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-tickets">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-tickets" data-method="GET"
      data-path="api/v1/admin/tickets"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-tickets', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-tickets"
                    onclick="tryItOut('GETapi-v1-admin-tickets');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-tickets"
                    onclick="cancelTryOut('GETapi-v1-admin-tickets');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-tickets"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/admin/tickets</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-admin-tickets"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-tickets"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-tickets"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-v1-admin-tickets"
               value="20"
               data-component="query">
    <br>
<p>Number of items per page. Must be at least 2. Must not be greater than 50. Example: <code>20</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-v1-admin-tickets"
               value="open"
               data-component="query">
    <br>
<p>Filter by ticket status. Example: <code>open</code></p>
Must be one of:
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter"                data-endpoint="GETapi-v1-admin-tickets"
               value=""
               data-component="query">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter.user_id"                data-endpoint="GETapi-v1-admin-tickets"
               value="01HZY1K8QK8ZQ2V6J8F4K8Q2V6"
               data-component="query">
    <br>
<p>Filter by user ID (ULID). Must be 26 characters. Example: <code>01HZY1K8QK8ZQ2V6J8F4K8Q2V6</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter.subject"                data-endpoint="GETapi-v1-admin-tickets"
               value="Issue with ride"
               data-component="query">
    <br>
<p>Filter by subject (partial match). Example: <code>Issue with ride</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>sort</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sort"                data-endpoint="GETapi-v1-admin-tickets"
               value="-created_at"
               data-component="query">
    <br>
<p>Sort field (prefix with - for descending). Example: <code>-created_at</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>created_at</code></li> <li><code>-created_at</code></li> <li><code>updated_at</code></li> <li><code>-updated_at</code></li> <li><code>subject</code></li> <li><code>-subject</code></li> <li><code>status</code></li> <li><code>-status</code></li></ul>
            </div>
                </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/admin/tickets/architecto" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/admin/tickets/architecto"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/admin/tickets/architecto';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-admin-tickets--id-">
            <blockquote>
            <p>Example response (200, Support ticket details retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-admin-tickets--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-tickets--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-tickets--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-tickets--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-tickets--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-tickets--id-" data-method="GET"
      data-path="api/v1/admin/tickets/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-tickets--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-tickets--id-"
                    onclick="tryItOut('GETapi-v1-admin-tickets--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-tickets--id-"
                    onclick="cancelTryOut('GETapi-v1-admin-tickets--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-tickets--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/admin/tickets/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-admin-tickets--id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-tickets--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-tickets--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-admin-tickets--id-"
               value="architecto"
               data-component="url">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/admin/tickets/architecto/comments" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/admin/tickets/architecto/comments"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/admin/tickets/architecto/comments';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-admin-tickets--ticket_id--comments">
            <blockquote>
...
<span id="execution-results-GETapi-v1-admin-tickets--ticket_id--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-tickets--ticket_id--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-tickets--ticket_id--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-tickets--ticket_id--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-tickets--ticket_id--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-tickets--ticket_id--comments" data-method="GET"
      data-path="api/v1/admin/tickets/{ticket_id}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-tickets--ticket_id--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-tickets--ticket_id--comments"
                    onclick="tryItOut('GETapi-v1-admin-tickets--ticket_id--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-tickets--ticket_id--comments"
                    onclick="cancelTryOut('GETapi-v1-admin-tickets--ticket_id--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-tickets--ticket_id--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/admin/tickets/{ticket_id}/comments</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-admin-tickets--ticket_id--comments"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-tickets--ticket_id--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-tickets--ticket_id--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ticket_id"                data-endpoint="GETapi-v1-admin-tickets--ticket_id--comments"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ticket. Example: <code>architecto</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/admin/promo-codes" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/admin/promo-codes"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/admin/promo-codes';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-v1-admin-promo-codes" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-promo-codes"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-promo-codes"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-promo-codes" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-promo-codes">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-promo-codes" data-method="GET"
      data-path="api/v1/admin/promo-codes"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-promo-codes', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-promo-codes"
                    onclick="tryItOut('GETapi-v1-admin-promo-codes');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-promo-codes"
                    onclick="cancelTryOut('GETapi-v1-admin-promo-codes');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-promo-codes"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/admin/promo-codes</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-admin-promo-codes"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-promo-codes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-promo-codes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    ...
    \"description\": \"Get 20% off your summer rides!\",
...
<span id="example-responses-POSTapi-v1-admin-promo-codes">
            <blockquote>
            <p>Example response (201, Promo code created successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-admin-promo-codes" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-promo-codes"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-promo-codes"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-promo-codes" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-promo-codes">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-promo-codes" data-method="POST"
      data-path="api/v1/admin/promo-codes"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-promo-codes', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-promo-codes"
                    onclick="tryItOut('POSTapi-v1-admin-promo-codes');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-promo-codes"
                    onclick="cancelTryOut('POSTapi-v1-admin-promo-codes');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-promo-codes"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-admin-promo-codes"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="SUMMER2024"
               data-component="body">
    <br>
<p>Unique promo code. Must not be greater than 50 characters. Example: <code>SUMMER2024</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="Summer Discount"
               data-component="body">
    <br>
<p>Display title for the promo code. Must not be greater than 255 characters. Example: <code>Summer Discount</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="Get 20% off your summer rides!"
               data-component="body">
    <br>
<p>Optional description. Example: <code>Get 20% off your summer rides!</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="discount_type"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="percentage"
               data-component="body">
    <br>
<p>Type of discount: fixed or percentage. Example: <code>percentage</code></p>
Must be one of:
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="discount_value"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="20"
               data-component="body">
    <br>
<p>Discount value (MDL for fixed, % for percentage). Must be at least 1. Example: <code>20</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>max_discount_amount</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="max_discount_amount"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="100"
               data-component="body">
    <br>
<p>Maximum discount amount for percentage type. Must be at least 1. Example: <code>100</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="min_order_amount"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="50"
               data-component="body">
    <br>
<p>Minimum order amount to apply promo. Must be at least 0. Example: <code>50</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="usage_limit"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="1000"
               data-component="body">
    <br>
<p>Total number of uses allowed. Must be at least 1. Example: <code>1000</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>usage_limit_per_user</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="usage_limit_per_user"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="1"
               data-component="body">
    <br>
<p>Number of uses per user. Must be at least 1. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="starts_at"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="2024-06-01 00:00:00"
               data-component="body">
    <br>
<p>When the promo becomes active. Must be a valid date. Example: <code>2024-06-01 00:00:00</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>expires_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="expires_at"                data-endpoint="POSTapi-v1-admin-promo-codes"
               value="2024-08-31 23:59:59"
               data-component="body">
    <br>
<p>When the promo expires. Must be a valid date. Must be a date after or equal to <code>starts_at</code>. Example: <code>2024-08-31 23:59:59</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-v1-admin-promo-codes" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="POSTapi-v1-admin-promo-codes"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-v1-admin-promo-codes" style="display: none">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/admin/promo-codes/architecto" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/admin/promo-codes/architecto"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/admin/promo-codes/architecto';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-v1-admin-promo-codes--promoCode_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-promo-codes--promoCode_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-promo-codes--promoCode_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-promo-codes--promoCode_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-promo-codes--promoCode_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-promo-codes--promoCode_id-" data-method="GET"
      data-path="api/v1/admin/promo-codes/{promoCode_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-promo-codes--promoCode_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-promo-codes--promoCode_id-"
                    onclick="tryItOut('GETapi-v1-admin-promo-codes--promoCode_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-promo-codes--promoCode_id-"
                    onclick="cancelTryOut('GETapi-v1-admin-promo-codes--promoCode_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-promo-codes--promoCode_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/admin/promo-codes/{promoCode_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-admin-promo-codes--promoCode_id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-promo-codes--promoCode_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-promo-codes--promoCode_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                        ...
                        <h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>promoCode_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="promoCode_id"                data-endpoint="GETapi-v1-admin-promo-codes--promoCode_id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the promoCode. Example: <code>architecto</code></p>
            </div>
                    </form>
...
<span id="example-responses-PUTapi-v1-admin-promo-codes--promoCode_id-">
            <blockquote>
            <p>Example response (200, Promo code updated successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-v1-admin-promo-codes--promoCode_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-admin-promo-codes--promoCode_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-admin-promo-codes--promoCode_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-admin-promo-codes--promoCode_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-admin-promo-codes--promoCode_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-admin-promo-codes--promoCode_id-" data-method="PUT"
      data-path="api/v1/admin/promo-codes/{promoCode_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-admin-promo-codes--promoCode_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-admin-promo-codes--promoCode_id-"
                    onclick="tryItOut('PUTapi-v1-admin-promo-codes--promoCode_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-admin-promo-codes--promoCode_id-"
                    onclick="cancelTryOut('PUTapi-v1-admin-promo-codes--promoCode_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-admin-promo-codes--promoCode_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="promoCode_id"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the promoCode. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="SUMMER2024"
               data-component="body">
    <br>
<p>Unique promo code. Must not be greater than 50 characters. Example: <code>SUMMER2024</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="Summer Discount"
               data-component="body">
    <br>
<p>Display title for the promo code. Must not be greater than 255 characters. Example: <code>Summer Discount</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="Get 20% off your summer rides!"
               data-component="body">
    <br>
<p>Optional description. Example: <code>Get 20% off your summer rides!</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="discount_type"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="percentage"
               data-component="body">
    <br>
<p>Type of discount: fixed or percentage. Example: <code>percentage</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="discount_value"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="20"
               data-component="body">
    <br>
<p>Discount value (MDL for fixed, % for percentage). Must be at least 1. Example: <code>20</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="max_discount_amount"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="100"
               data-component="body">
    <br>
<p>Maximum discount amount for percentage type. Must be at least 1. Example: <code>100</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="min_order_amount"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="50"
               data-component="body">
    <br>
<p>Minimum order amount to apply promo. Must be at least 0. Example: <code>50</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="usage_limit"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="1000"
               data-component="body">
    <br>
<p>Total number of uses allowed. Must be at least 1. Example: <code>1000</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="usage_limit_per_user"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="1"
               data-component="body">
    <br>
<p>Number of uses per user. Must be at least 1. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="starts_at"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="2024-06-01 00:00:00"
               data-component="body">
    <br>
<p>When the promo becomes active. Must be a valid date. Example: <code>2024-06-01 00:00:00</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="expires_at"                data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
               value="2024-08-31 23:59:59"
               data-component="body">
    <br>
<p>When the promo expires. Must be a valid date. Must be a date after or equal to <code>starts_at</code>. Example: <code>2024-08-31 23:59:59</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-v1-admin-promo-codes--promoCode_id-" style="display: none">
...
<span id="example-responses-DELETEapi-v1-admin-promo-codes--promoCode_id-">
</span>
<span id="execution-results-DELETEapi-v1-admin-promo-codes--promoCode_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-admin-promo-codes--promoCode_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-admin-promo-codes--promoCode_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-admin-promo-codes--promoCode_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-admin-promo-codes--promoCode_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-admin-promo-codes--promoCode_id-" data-method="DELETE"
      data-path="api/v1/admin/promo-codes/{promoCode_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-admin-promo-codes--promoCode_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-admin-promo-codes--promoCode_id-"
                    onclick="tryItOut('DELETEapi-v1-admin-promo-codes--promoCode_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-admin-promo-codes--promoCode_id-"
                    onclick="cancelTryOut('DELETEapi-v1-admin-promo-codes--promoCode_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-admin-promo-codes--promoCode_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-admin-promo-codes--promoCode_id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-admin-promo-codes--promoCode_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-admin-promo-codes--promoCode_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="promoCode_id"                data-endpoint="DELETEapi-v1-admin-promo-codes--promoCode_id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the promoCode. Example: <code>architecto</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/admin/users/architecto/credits" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"amount\": 100,
    \"description\": \"Compensation for cancelled ride\"
}"
</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/admin/users/architecto/credits';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-admin-users--user_id--credits">
            <blockquote>
            <p>Example response (200, Credits adjusted successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-admin-users--user_id--credits" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-users--user_id--credits"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-users--user_id--credits"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-users--user_id--credits" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-users--user_id--credits">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-users--user_id--credits" data-method="POST"
      data-path="api/v1/admin/users/{user_id}/credits"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-users--user_id--credits', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-users--user_id--credits"
                    onclick="tryItOut('POSTapi-v1-admin-users--user_id--credits');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-users--user_id--credits"
                    onclick="cancelTryOut('POSTapi-v1-admin-users--user_id--credits');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-users--user_id--credits"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/users/{user_id}/credits</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-admin-users--user_id--credits"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-users--user_id--credits"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-users--user_id--credits"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="user_id"                data-endpoint="POSTapi-v1-admin-users--user_id--credits"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the user. Example: <code>architecto</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="amount"                data-endpoint="POSTapi-v1-admin-users--user_id--credits"
               value="100"
               data-component="body">
    <br>
<p>Amount to add (positive) or deduct (negative). Example: <code>100</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-v1-admin-users--user_id--credits"
               value="Compensation for cancelled ride"
               data-component="body">
    <br>
<p>Reason for the adjustment. Must not be greater than 255 characters. Example: <code>Compensation for cancelled ride</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/stats" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/stats"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/stats';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-stats">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;data&quot;: {
        ...
        &quot;completion_rate&quot;: 90,
        &quot;average_rating&quot;: 4.8,
        &quot;average_earnings_per_ride&quot;: 25.5,
        &quot;total_earned&quot;: 1147.5
    }
}</code>
 </pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Forbidden - User does not have driver role or profile incomplete):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-stats" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-stats"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-stats"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-stats" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-stats">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-stats" data-method="GET"
      data-path="api/v1/driver/stats"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-stats', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-stats"
                    onclick="tryItOut('GETapi-v1-driver-stats');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-stats"
                    onclick="cancelTryOut('GETapi-v1-driver-stats');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-stats"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/stats</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-stats"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-stats"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-stats"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/achievements?status=completed&amp;per_page=15" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/achievements"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/achievements';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-achievements">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-achievements" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-achievements"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-achievements"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-achievements" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-achievements">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-achievements" data-method="GET"
      data-path="api/v1/driver/achievements"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-achievements', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-achievements"
                    onclick="tryItOut('GETapi-v1-driver-achievements');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-achievements"
                    onclick="cancelTryOut('GETapi-v1-driver-achievements');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-achievements"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/achievements</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-achievements"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-achievements"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-achievements"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-v1-driver-achievements"
               value="completed"
               data-component="query">
    <br>
<p>Filter by status: completed, in_progress Example: <code>completed</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>per_page</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-v1-driver-achievements"
               value="15"
               data-component="query">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/level" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/level"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/level';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-level">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-level" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-level"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-level"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-level" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-level">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-level" data-method="GET"
      data-path="api/v1/driver/level"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-level', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-level"
                    onclick="tryItOut('GETapi-v1-driver-level');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-level"
                    onclick="cancelTryOut('GETapi-v1-driver-level');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-level"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/level</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-level"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-level"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-level"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/earnings/daily?from=2026-01-01&amp;to=2026-01-31" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/earnings/daily"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/earnings/daily';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-earnings-daily">
            <blockquote>
            <p>Example response (200, Daily earnings retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-earnings-daily" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-earnings-daily"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-earnings-daily"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-earnings-daily" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-earnings-daily">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-earnings-daily" data-method="GET"
      data-path="api/v1/driver/earnings/daily"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-earnings-daily', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-earnings-daily"
                    onclick="tryItOut('GETapi-v1-driver-earnings-daily');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-earnings-daily"
                    onclick="cancelTryOut('GETapi-v1-driver-earnings-daily');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-earnings-daily"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/earnings/daily</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-earnings-daily"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-earnings-daily"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-earnings-daily"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="from"                data-endpoint="GETapi-v1-driver-earnings-daily"
               value="2026-01-01"
               data-component="query">
    <br>
<p>Start date (Y-m-d). Defaults to 30 days ago. Example: <code>2026-01-01</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="to"                data-endpoint="GETapi-v1-driver-earnings-daily"
               value="2026-01-31"
               data-component="query">
    <br>
<p>End date (Y-m-d). Defaults to today. Example: <code>2026-01-31</code></p>
            </div>
                </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/earnings/weekly?weeks=4" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/earnings/weekly"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/earnings/weekly';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-v1-driver-earnings-weekly" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-earnings-weekly"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-earnings-weekly"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-earnings-weekly" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-earnings-weekly">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-earnings-weekly" data-method="GET"
      data-path="api/v1/driver/earnings/weekly"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-earnings-weekly', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-earnings-weekly"
                    onclick="tryItOut('GETapi-v1-driver-earnings-weekly');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-earnings-weekly"
                    onclick="cancelTryOut('GETapi-v1-driver-earnings-weekly');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-earnings-weekly"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/earnings/weekly</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-earnings-weekly"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-earnings-weekly"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-earnings-weekly"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                            ...
                            <h4 class="fancy-heading-panel"><b>Query Parameters</b></h4>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>weeks</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="weeks"                data-endpoint="GETapi-v1-driver-earnings-weekly"
               value="4"
               data-component="query">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/heatmap" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/heatmap"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/heatmap';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-heatmap">
            <blockquote>
            <p>Example response (200, Heatmap data retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-heatmap" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-heatmap"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-heatmap"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-heatmap" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-heatmap">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-heatmap" data-method="GET"
      data-path="api/v1/driver/heatmap"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-heatmap', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-heatmap"
                    onclick="tryItOut('GETapi-v1-driver-heatmap');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-heatmap"
                    onclick="cancelTryOut('GETapi-v1-driver-heatmap');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-heatmap"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/heatmap</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-heatmap"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-heatmap"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-heatmap"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/rides/history" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/rides/history"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/rides/history';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-rides-history">
            <blockquote>
...
<span id="execution-results-GETapi-v1-driver-rides-history" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-rides-history"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-rides-history"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-rides-history" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-rides-history">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-rides-history" data-method="GET"
      data-path="api/v1/driver/rides/history"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-rides-history', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-rides-history"
                    onclick="tryItOut('GETapi-v1-driver-rides-history');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-rides-history"
                    onclick="cancelTryOut('GETapi-v1-driver-rides-history');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-rides-history"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/rides/history</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-rides-history"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-rides-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-rides-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/bans/active" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/bans/active"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/bans/active';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-bans-active">
            <blockquote>
            <p>Example response (200, Active driver bans retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-bans-active" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-bans-active"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-bans-active"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-bans-active" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-bans-active">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-bans-active" data-method="GET"
      data-path="api/v1/driver/bans/active"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-bans-active', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-bans-active"
                    onclick="tryItOut('GETapi-v1-driver-bans-active');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-bans-active"
                    onclick="cancelTryOut('GETapi-v1-driver-bans-active');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-bans-active"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/bans/active</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-bans-active"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-bans-active"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-bans-active"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/bans/architecto" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/bans/architecto"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/bans/architecto';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-bans--id-">
            <blockquote>
            <p>Example response (200, Driver ban details retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (404, Driver ban not found.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-bans--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-bans--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-bans--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-bans--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-bans--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-bans--id-" data-method="GET"
      data-path="api/v1/driver/bans/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-bans--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-bans--id-"
                    onclick="tryItOut('GETapi-v1-driver-bans--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-bans--id-"
                    onclick="cancelTryOut('GETapi-v1-driver-bans--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-bans--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/bans/{id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-bans--id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-bans--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-bans--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-driver-bans--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ban. Example: <code>architecto</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ban"                data-endpoint="GETapi-v1-driver-bans--id-"
               value="01HZY2K8J8QK8Z8Z8Z8Z8Z8Z8Z"
               data-component="url">
    <br>
<p>ULID of the driver ban. Example: <code>01HZY2K8J8QK8Z8Z8Z8Z8Z8Z8Z</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/driver/tickets/architecto/comments" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"message\": \"I have additional details about this issue.\"
}"
</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/tickets/architecto/comments';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-driver-tickets--ticket_id--comments">
            <blockquote>
            <p>Example response (201, Support ticket comment created successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-driver-tickets--ticket_id--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-driver-tickets--ticket_id--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-driver-tickets--ticket_id--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-driver-tickets--ticket_id--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-driver-tickets--ticket_id--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-driver-tickets--ticket_id--comments" data-method="POST"
      data-path="api/v1/driver/tickets/{ticket_id}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-driver-tickets--ticket_id--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-driver-tickets--ticket_id--comments"
                    onclick="tryItOut('POSTapi-v1-driver-tickets--ticket_id--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-driver-tickets--ticket_id--comments"
                    onclick="cancelTryOut('POSTapi-v1-driver-tickets--ticket_id--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-driver-tickets--ticket_id--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/driver/tickets/{ticket_id}/comments</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-driver-tickets--ticket_id--comments"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-driver-tickets--ticket_id--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-driver-tickets--ticket_id--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ticket_id"                data-endpoint="POSTapi-v1-driver-tickets--ticket_id--comments"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ticket. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ticket"                data-endpoint="POSTapi-v1-driver-tickets--ticket_id--comments"
               value="01HZY2K8J8QK8Z8Z8Z8Z8Z8Z8Z"
               data-component="url">
    <br>
<p>ULID of the support ticket. Example: <code>01HZY2K8J8QK8Z8Z8Z8Z8Z8Z8Z</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="message"                data-endpoint="POSTapi-v1-driver-tickets--ticket_id--comments"
               value="I have additional details about this issue."
               data-component="body">
    <br>
<p>Comment message for the support ticket. Must not be greater than 5000 characters. Example: <code>I have additional details about this issue.</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/driver/location/current" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/driver/location/current"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/driver/location/current';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-driver-location-current">
            <blockquote>
            <p>Example response (200, Driver current location retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-driver-location-current" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-driver-location-current"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-driver-location-current"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-driver-location-current" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-driver-location-current">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-driver-location-current" data-method="GET"
      data-path="api/v1/driver/location/current"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-driver-location-current', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-driver-location-current"
                    onclick="tryItOut('GETapi-v1-driver-location-current');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-driver-location-current"
                    onclick="cancelTryOut('GETapi-v1-driver-location-current');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-driver-location-current"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/driver/location/current</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-driver-location-current"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-driver-location-current"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-driver-location-current"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/rider/rides/architecto/share" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    ...
    \"message\": \"This is my current ride. Stay safe!\"
}"
</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/rides/architecto/share';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-rider-rides--ride_id--share">
            <blockquote>
            <p>Example response (201, Ride shared successfully.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Forbidden - You can only share your own rides.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-rider-rides--ride_id--share" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-rider-rides--ride_id--share"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-rider-rides--ride_id--share"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-rider-rides--ride_id--share" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-rider-rides--ride_id--share">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-rider-rides--ride_id--share" data-method="POST"
      data-path="api/v1/rider/rides/{ride_id}/share"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-rider-rides--ride_id--share', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-rider-rides--ride_id--share"
                    onclick="tryItOut('POSTapi-v1-rider-rides--ride_id--share');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-rider-rides--ride_id--share"
                    onclick="cancelTryOut('POSTapi-v1-rider-rides--ride_id--share');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-rider-rides--ride_id--share"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/rider/rides/{ride_id}/share</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="01jk9v6v9v6v9v6v9v6v9v6v9v"
               data-component="url">
    <br>
<p>ULID of the ride. Example: <code>01jk9v6v9v6v9v6v9v6v9v6v9v</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="contact_name"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="John Doe"
               data-component="body">
    <br>
<p>Name of the contact person to share the ride with. Must not be greater than 255 characters. Example: <code>John Doe</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="contact_phone"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="+1234567890"
               data-component="body">
    <br>
<p>Phone number of the contact person. Must not be greater than 20 characters. Example: <code>+1234567890</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="contact_email"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="john@example.com"
               data-component="body">
    <br>
<p>Email address of the contact person (optional). Must be a valid email address. Must not be greater than 255 characters. Example: <code>john@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>message</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="message"                data-endpoint="POSTapi-v1-rider-rides--ride_id--share"
               value="This is my current ride. Stay safe!"
               data-component="body">
    <br>
<p>Custom message to include with the ride share notification. Must not be greater than 500 characters. Example: <code>This is my current ride. Stay safe!</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/ride/architecto/splits" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/ride/architecto/splits"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/ride/architecto/splits';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-ride--ride_id--splits">
            <blockquote>
            <p>Example response (200, List of ride split participants.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Forbidden - You can only view splits of your own rides.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-ride--ride_id--splits" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-ride--ride_id--splits"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-ride--ride_id--splits"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-ride--ride_id--splits" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-ride--ride_id--splits">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-ride--ride_id--splits" data-method="GET"
      data-path="api/v1/ride/{ride_id}/splits"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-ride--ride_id--splits', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-ride--ride_id--splits"
                    onclick="tryItOut('GETapi-v1-ride--ride_id--splits');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-ride--ride_id--splits"
                    onclick="cancelTryOut('GETapi-v1-ride--ride_id--splits');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-ride--ride_id--splits"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/ride/{ride_id}/splits</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-ride--ride_id--splits"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-ride--ride_id--splits"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-ride--ride_id--splits"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="GETapi-v1-ride--ride_id--splits"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride"                data-endpoint="GETapi-v1-ride--ride_id--splits"
               value="01jk9v6v9v6v9v6v9v6v9v6v9v"
               data-component="url">
    <br>
<p>ULID of the ride. Example: <code>01jk9v6v9v6v9v6v9v6v9v6v9v</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/ride/architecto/split" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/ride/architecto/split';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-ride--ride_id--split">
            <blockquote>
            <p>Example response (201, Ride split created successfully.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Forbidden - You can only split your own rides.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-ride--ride_id--split" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-ride--ride_id--split"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-ride--ride_id--split"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-ride--ride_id--split" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-ride--ride_id--split">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-ride--ride_id--split" data-method="POST"
      data-path="api/v1/ride/{ride_id}/split"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-ride--ride_id--split', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-ride--ride_id--split"
                    onclick="tryItOut('POSTapi-v1-ride--ride_id--split');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-ride--ride_id--split"
                    onclick="cancelTryOut('POSTapi-v1-ride--ride_id--split');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-ride--ride_id--split"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/ride/{ride_id}/split</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride"                data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="01jk9v6v9v6v9v6v9v6v9v6v9v"
               data-component="url">
    <br>
<p>ULID of the ride. Example: <code>01jk9v6v9v6v9v6v9v6v9v6v9v</code></p>
...
<small>object[]</small>&nbsp;
 ...
 &nbsp;
<br>
<p>List of participants to split the ride with. Must have at least 1 items.</p>
            </summary>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="participants.0.name"                data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="n"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="participants.0.email"                data-endpoint="POSTapi-v1-ride--ride_id--split"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="participants.0.phone"                data-endpoint="POSTapi-v1-ride--ride_id--split"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="participants.0.share"                data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="25"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="note"                data-endpoint="POSTapi-v1-ride--ride_id--split"
               value="b"
               data-component="body">
    <br>
<p>Optional note for the split. Must not be greater than 500 characters. Example: <code>b</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/routes/favorite" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/routes/favorite"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/routes/favorite';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-rider-routes-favorite">
            <blockquote>
            <p>Example response (200, Favorite routes retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-routes-favorite" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-routes-favorite"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-routes-favorite"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-routes-favorite" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-routes-favorite">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-routes-favorite" data-method="GET"
      data-path="api/v1/rider/routes/favorite"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-routes-favorite', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-routes-favorite"
                    onclick="tryItOut('GETapi-v1-rider-routes-favorite');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-routes-favorite"
                    onclick="cancelTryOut('GETapi-v1-rider-routes-favorite');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-routes-favorite"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/routes/favorite</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-routes-favorite"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-routes-favorite"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-routes-favorite"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<span id="example-responses-POSTapi-v1-rider-routes-favorite">
            <blockquote>
            <p>Example response (201, Favorite route created successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-rider-routes-favorite" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-rider-routes-favorite"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-rider-routes-favorite"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-rider-routes-favorite" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-rider-routes-favorite">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-rider-routes-favorite" data-method="POST"
      data-path="api/v1/rider/routes/favorite"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-rider-routes-favorite', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-rider-routes-favorite"
                    onclick="tryItOut('POSTapi-v1-rider-routes-favorite');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-rider-routes-favorite"
                    onclick="cancelTryOut('POSTapi-v1-rider-routes-favorite');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-rider-routes-favorite"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="Home to Work"
               data-component="body">
    <br>
<p>Route name (e.g., Home-Work). Must not be greater than 255 characters. Example: <code>Home to Work</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="origin_address"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="123 Main St, New York"
               data-component="body">
    <br>
<p>Origin address. Must not be greater than 500 characters. Example: <code>123 Main St, New York</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lat"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="40.7128"
               data-component="body">
    <br>
<p>Origin latitude. Must be between -90 and 90. Example: <code>40.7128</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lng"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="-74.006"
               data-component="body">
    <br>
<p>Origin longitude. Must be between -180 and 180. Example: <code>-74.006</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="destination_address"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="456 Park Ave, New York"
               data-component="body">
    <br>
<p>Destination address. Must not be greater than 500 characters. Example: <code>456 Park Ave, New York</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lat"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="40.7589"
               data-component="body">
    <br>
<p>Destination latitude. Must be between -90 and 90. Example: <code>40.7589</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lng"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="-73.9851"
               data-component="body">
    <br>
<p>Destination longitude. Must be between -180 and 180. Example: <code>-73.9851</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="POSTapi-v1-rider-routes-favorite"
               value="work"
               data-component="body">
    <br>
<p>Route type (home, work, gym, other). Example: <code>work</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>home</code></li> <li><code>work</code></li> <li><code>gym</code></li> <li><code>other</code></li></ul>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/routes/favorite/architecto" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/routes/favorite/architecto"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/routes/favorite/architecto';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-rider-routes-favorite--route_id-">
            <blockquote>
            <p>Example response (200, Favorite route retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (404, Favorite route not found):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-routes-favorite--route_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-routes-favorite--route_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-routes-favorite--route_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-routes-favorite--route_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-routes-favorite--route_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-routes-favorite--route_id-" data-method="GET"
      data-path="api/v1/rider/routes/favorite/{route_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-routes-favorite--route_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-routes-favorite--route_id-"
                    onclick="tryItOut('GETapi-v1-rider-routes-favorite--route_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-routes-favorite--route_id-"
                    onclick="cancelTryOut('GETapi-v1-rider-routes-favorite--route_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-routes-favorite--route_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/routes/favorite/{route_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-routes-favorite--route_id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-routes-favorite--route_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-routes-favorite--route_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="route_id"                data-endpoint="GETapi-v1-rider-routes-favorite--route_id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the route. Example: <code>architecto</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="route"                data-endpoint="GETapi-v1-rider-routes-favorite--route_id-"
               value="01jmk9v6v9v6v9v6v9v6v9v6v9"
               data-component="url">
    <br>
<p>ULID of the favorite route. Example: <code>01jmk9v6v9v6v9v6v9v6v9v6v9</code></p>
            </div>
                    </form>
...
<span id="example-responses-PUTapi-v1-rider-routes-favorite--route_id-">
            <blockquote>
            <p>Example response (200, Favorite route updated successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-v1-rider-routes-favorite--route_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-rider-routes-favorite--route_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-rider-routes-favorite--route_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-rider-routes-favorite--route_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-rider-routes-favorite--route_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-rider-routes-favorite--route_id-" data-method="PUT"
      data-path="api/v1/rider/routes/favorite/{route_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-rider-routes-favorite--route_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-rider-routes-favorite--route_id-"
                    onclick="tryItOut('PUTapi-v1-rider-routes-favorite--route_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-rider-routes-favorite--route_id-"
                    onclick="cancelTryOut('PUTapi-v1-rider-routes-favorite--route_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-rider-routes-favorite--route_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="route_id"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the route. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="route"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="01jmk9v6v9v6v9v6v9v6v9v6v9"
               data-component="url">
    <br>
<p>ULID of the favorite route. Example: <code>01jmk9v6v9v6v9v6v9v6v9v6v9</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="Home to Work"
               data-component="body">
    <br>
<p>Route name (e.g., Home-Work). Must not be greater than 255 characters. Example: <code>Home to Work</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="origin_address"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="123 Main St, New York"
               data-component="body">
    <br>
<p>Origin address. Must not be greater than 500 characters. Example: <code>123 Main St, New York</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lat"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="40.7128"
               data-component="body">
    <br>
<p>Origin latitude. Must be between -90 and 90. Example: <code>40.7128</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lng"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="-74.006"
               data-component="body">
    <br>
<p>Origin longitude. Must be between -180 and 180. Example: <code>-74.006</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="destination_address"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="456 Park Ave, New York"
               data-component="body">
    <br>
<p>Destination address. Must not be greater than 500 characters. Example: <code>456 Park Ave, New York</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lat"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="40.7589"
               data-component="body">
    <br>
<p>Destination latitude. Must be between -90 and 90. Example: <code>40.7589</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lng"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="-73.9851"
               data-component="body">
    <br>
<p>Destination longitude. Must be between -180 and 180. Example: <code>-73.9851</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="type"                data-endpoint="PUTapi-v1-rider-routes-favorite--route_id-"
               value="work"
               data-component="body">
    <br>
<p>Route type (home, work, school, gym, other). Example: <code>work</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>home</code></li> <li><code>work</code></li> <li><code>school</code></li> <li><code>gym</code></li> <li><code>other</code></li></ul>
        </div>
        </form>
...
<span id="example-responses-DELETEapi-v1-rider-routes-favorite--route_id-">
            <blockquote>
            <p>Example response (200, Favorite route deleted successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-DELETEapi-v1-rider-routes-favorite--route_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-rider-routes-favorite--route_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-rider-routes-favorite--route_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-rider-routes-favorite--route_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-rider-routes-favorite--route_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-rider-routes-favorite--route_id-" data-method="DELETE"
      data-path="api/v1/rider/routes/favorite/{route_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-rider-routes-favorite--route_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-rider-routes-favorite--route_id-"
                    onclick="tryItOut('DELETEapi-v1-rider-routes-favorite--route_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-rider-routes-favorite--route_id-"
                    onclick="cancelTryOut('DELETEapi-v1-rider-routes-favorite--route_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-rider-routes-favorite--route_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-rider-routes-favorite--route_id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-rider-routes-favorite--route_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-rider-routes-favorite--route_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="route_id"                data-endpoint="DELETEapi-v1-rider-routes-favorite--route_id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the route. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="route"                data-endpoint="DELETEapi-v1-rider-routes-favorite--route_id-"
               value="01jmk9v6v9v6v9v6v9v6v9v6v9"
               data-component="url">
    <br>
<p>ULID of the favorite route. Example: <code>01jmk9v6v9v6v9v6v9v6v9v6v9</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/favorites/architecto" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-GETapi-v1-rider-favorites--id-">
            <blockquote>
            <p>Example response (200, Favorite location retrieved successfully):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-favorites--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-favorites--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-favorites--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-favorites--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-favorites--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-favorites--id-" data-method="GET"
      data-path="api/v1/rider/favorites/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-favorites--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-favorites--id-"
                    onclick="tryItOut('GETapi-v1-rider-favorites--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-favorites--id-"
                    onclick="cancelTryOut('GETapi-v1-rider-favorites--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-favorites--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-favorites--id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-favorites--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-favorites--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-rider-favorites--id-"
               value="architecto"
               data-component="url">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/rides/scheduled" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/rides/scheduled"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/rides/scheduled';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-rider-rides-scheduled">
            <blockquote>
            <p>Example response (200, Paginated scheduled rides retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-rides-scheduled" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-rides-scheduled"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-rides-scheduled"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-rides-scheduled" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-rides-scheduled">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-rides-scheduled" data-method="GET"
      data-path="api/v1/rider/rides/scheduled"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-rides-scheduled', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-rides-scheduled"
                    onclick="tryItOut('GETapi-v1-rider-rides-scheduled');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-rides-scheduled"
                    onclick="cancelTryOut('GETapi-v1-rider-rides-scheduled');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-rides-scheduled"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/rides/scheduled</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-rides-scheduled"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-rides-scheduled"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-rides-scheduled"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<span id="example-responses-POSTapi-v1-rider-rides-scheduled">
            <blockquote>
            <p>Example response (201, Ride scheduled successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-rider-rides-scheduled" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-rider-rides-scheduled"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-rider-rides-scheduled"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-rider-rides-scheduled" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-rider-rides-scheduled">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-rider-rides-scheduled" data-method="POST"
      data-path="api/v1/rider/rides/scheduled"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-rider-rides-scheduled', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-rider-rides-scheduled"
                    onclick="tryItOut('POSTapi-v1-rider-rides-scheduled');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-rider-rides-scheduled"
                    onclick="cancelTryOut('POSTapi-v1-rider-rides-scheduled');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-rider-rides-scheduled"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="origin_address"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="bd. Ștefan cel Mare și Sfânt, 1, Chișinău"
               data-component="body">
    <br>
<p>The starting address of the ride. Must not be greater than 255 characters. Example: <code>bd. Ștefan cel Mare și Sfânt, 1, Chișinău</code></p>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lat"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="47.0105"
               data-component="body">
    <br>
<p>The latitude of the origin. Must be between -90 and 90. Example: <code>47.0105</code></p>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lng"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="28.8638"
               data-component="body">
    <br>
<p>The longitude of the origin. Must be between -180 and 180. Example: <code>28.8638</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="destination_address"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="str. Mihai Eminescu, 50, Chișinău"
               data-component="body">
    <br>
<p>The destination address of the ride. Must not be greater than 255 characters. Example: <code>str. Mihai Eminescu, 50, Chișinău</code></p>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lat"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="47.0225"
               data-component="body">
    <br>
<p>The latitude of the destination. Must be between -90 and 90. Example: <code>47.0225</code></p>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lng"                data-endpoint="POSTapi-v1-rider-rides-scheduled"
               value="28.8353"
               data-component="body">
    <br>
<p>The longitude of the destination. Must be between -180 and 180. Example: <code>28.8353</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8080/api/v1/rider/rides/scheduled/architecto" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/rides/scheduled/architecto';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-PUTapi-v1-rider-rides-scheduled--ride_id-">
            <blockquote>
            <p>Example response (200, Scheduled ride updated successfully.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Cannot update this ride.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-v1-rider-rides-scheduled--ride_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-rider-rides-scheduled--ride_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-rider-rides-scheduled--ride_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-rider-rides-scheduled--ride_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-rider-rides-scheduled--ride_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-rider-rides-scheduled--ride_id-" data-method="PUT"
      data-path="api/v1/rider/rides/scheduled/{ride_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-rider-rides-scheduled--ride_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-rider-rides-scheduled--ride_id-"
                    onclick="tryItOut('PUTapi-v1-rider-rides-scheduled--ride_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-rider-rides-scheduled--ride_id-"
                    onclick="cancelTryOut('PUTapi-v1-rider-rides-scheduled--ride_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-rider-rides-scheduled--ride_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/v1/rider/rides/scheduled/{ride_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="origin_address"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="bd. Ștefan cel Mare și Sfânt, 1, Chișinău"
               data-component="body">
    <br>
<p>The updated starting address of the ride. Must not be greater than 255 characters. Example: <code>bd. Ștefan cel Mare și Sfânt, 1, Chișinău</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>origin_lat</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lat"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="47.0105"
               data-component="body">
    <br>
<p>The latitude of the origin. This field is required when <code>origin_address</code> is present. Must be between -90 and 90. Example: <code>47.0105</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>origin_lng</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="origin_lng"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="28.8638"
               data-component="body">
    <br>
<p>The longitude of the origin. This field is required when <code>origin_address</code> is present. Must be between -180 and 180. Example: <code>28.8638</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>destination_address</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="destination_address"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="str. Mihai Eminescu, 50, Chișinău"
               data-component="body">
    <br>
<p>The updated destination address of the ride. Must not be greater than 255 characters. Example: <code>str. Mihai Eminescu, 50, Chișinău</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>destination_lat</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lat"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="47.0225"
               data-component="body">
    <br>
<p>The latitude of the destination. This field is required when <code>destination_address</code> is present. Must be between -90 and 90. Example: <code>47.0225</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>destination_lng</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="destination_lng"                data-endpoint="PUTapi-v1-rider-rides-scheduled--ride_id-"
               value="28.8353"
               data-component="body">
    <br>
<p>The longitude of the destination. This field is required when <code>destination_address</code> is present. Must be between -180 and 180. Example: <code>28.8353</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>scheduled_at</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/rides/architecto/fare-breakdown" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/rides/architecto/fare-breakdown"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/rides/architecto/fare-breakdown';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-rider-rides--ride_id--fare-breakdown">
            <blockquote>
            <p>Example response (200, Fare breakdown retrieved successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-rides--ride_id--fare-breakdown" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-rides--ride_id--fare-breakdown"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-rides--ride_id--fare-breakdown"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-rides--ride_id--fare-breakdown" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-rides--ride_id--fare-breakdown">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-rides--ride_id--fare-breakdown" data-method="GET"
      data-path="api/v1/rider/rides/{ride_id}/fare-breakdown"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-rides--ride_id--fare-breakdown', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-rides--ride_id--fare-breakdown"
                    onclick="tryItOut('GETapi-v1-rider-rides--ride_id--fare-breakdown');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-rides--ride_id--fare-breakdown"
                    onclick="cancelTryOut('GETapi-v1-rider-rides--ride_id--fare-breakdown');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-rides--ride_id--fare-breakdown"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/rides/{ride_id}/fare-breakdown</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-rides--ride_id--fare-breakdown"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-rides--ride_id--fare-breakdown"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-rides--ride_id--fare-breakdown"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="GETapi-v1-rider-rides--ride_id--fare-breakdown"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8080/api/v1/rider/rides/architecto/note" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"note\": \"Please ring the doorbell twice. Blue house with white gate.\"
}"
</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/rides/architecto/note';
$response = $client-&gt;put(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-PUTapi-v1-rider-rides--ride_id--note">
            <blockquote>
            <p>Example response (200, Note updated successfully.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Forbidden - You can only update notes for your own pending or scheduled rides.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-v1-rider-rides--ride_id--note" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-rider-rides--ride_id--note"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-rider-rides--ride_id--note"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-rider-rides--ride_id--note" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-rider-rides--ride_id--note">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-rider-rides--ride_id--note" data-method="PUT"
      data-path="api/v1/rider/rides/{ride_id}/note"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-rider-rides--ride_id--note', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-rider-rides--ride_id--note"
                    onclick="tryItOut('PUTapi-v1-rider-rides--ride_id--note');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-rider-rides--ride_id--note"
                    onclick="cancelTryOut('PUTapi-v1-rider-rides--ride_id--note');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-rider-rides--ride_id--note"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/v1/rider/rides/{ride_id}/note</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-rider-rides--ride_id--note"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-rider-rides--ride_id--note"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-rider-rides--ride_id--note"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="PUTapi-v1-rider-rides--ride_id--note"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride"                data-endpoint="PUTapi-v1-rider-rides--ride_id--note"
               value="01jk9v6v9v6v9v6v9v6v9v6v9v"
               data-component="url">
    <br>
<p>ULID of the ride. Example: <code>01jk9v6v9v6v9v6v9v6v9v6v9v</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="note"                data-endpoint="PUTapi-v1-rider-rides--ride_id--note"
               value="Please ring the doorbell twice. Blue house with white gate."
               data-component="body">
    <br>
<p>Pickup/dropoff instructions for the driver. Example: <code>Please ring the doorbell twice. Blue house with white gate.</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/rider/rides/architecto/verify-pin" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/rides/architecto/verify-pin';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-rider-rides--ride_id--verify-pin">
            <blockquote>
            <p>Example response (200, PIN verified successfully):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (400, PIN already verified):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Not authorized to verify this ride):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-rider-rides--ride_id--verify-pin" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-rider-rides--ride_id--verify-pin"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-rider-rides--ride_id--verify-pin"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-rider-rides--ride_id--verify-pin" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-rider-rides--ride_id--verify-pin">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-rider-rides--ride_id--verify-pin" data-method="POST"
      data-path="api/v1/rider/rides/{ride_id}/verify-pin"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-rider-rides--ride_id--verify-pin', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-rider-rides--ride_id--verify-pin"
                    onclick="tryItOut('POSTapi-v1-rider-rides--ride_id--verify-pin');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-rider-rides--ride_id--verify-pin"
                    onclick="cancelTryOut('POSTapi-v1-rider-rides--ride_id--verify-pin');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-rider-rides--ride_id--verify-pin"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/rider/rides/{ride_id}/verify-pin</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-rider-rides--ride_id--verify-pin"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-rider-rides--ride_id--verify-pin"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-rider-rides--ride_id--verify-pin"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="POSTapi-v1-rider-rides--ride_id--verify-pin"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride"                data-endpoint="POSTapi-v1-rider-rides--ride_id--verify-pin"
               value="01HZY2K8J8QK8Z8Z8Z8Z8Z8Z8Z"
               data-component="url">
    <br>
<p>ULID of the ride. Example: <code>01HZY2K8J8QK8Z8Z8Z8Z8Z8Z8Z</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/achievements?status=completed&amp;per_page=15" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/achievements"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/achievements';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-rider-achievements">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-achievements" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-achievements"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-achievements"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-achievements" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-achievements">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-achievements" data-method="GET"
      data-path="api/v1/rider/achievements"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-achievements', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-achievements"
                    onclick="tryItOut('GETapi-v1-rider-achievements');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-achievements"
                    onclick="cancelTryOut('GETapi-v1-rider-achievements');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-achievements"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/achievements</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-achievements"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-achievements"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-achievements"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="GETapi-v1-rider-achievements"
               value="completed"
               data-component="query">
    <br>
<p>Filter by status: completed, in_progress Example: <code>completed</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="per_page"                data-endpoint="GETapi-v1-rider-achievements"
               value="15"
               data-component="query">
    <br>
<p>Items per page Example: <code>15</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/level" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/level"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/level';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-rider-level">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-level" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-level"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-level"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-level" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-level">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-level" data-method="GET"
      data-path="api/v1/rider/level"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-level', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-level"
                    onclick="tryItOut('GETapi-v1-rider-level');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-level"
                    onclick="cancelTryOut('GETapi-v1-rider-level');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-level"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/level</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-level"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-level"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-level"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/streak" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/streak"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/streak';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-rider-streak">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-rider-streak" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-streak"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-streak"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-streak" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-streak">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-streak" data-method="GET"
      data-path="api/v1/rider/streak"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-streak', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-streak"
                    onclick="tryItOut('GETapi-v1-rider-streak');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-streak"
                    onclick="cancelTryOut('GETapi-v1-rider-streak');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-streak"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/streak</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-streak"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-streak"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-streak"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/rider/credits" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/rider/credits"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/credits';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="execution-results-GETapi-v1-rider-credits" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-rider-credits"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-rider-credits"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-rider-credits" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-rider-credits">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-rider-credits" data-method="GET"
      data-path="api/v1/rider/credits"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-rider-credits', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-rider-credits"
                    onclick="tryItOut('GETapi-v1-rider-credits');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-rider-credits"
                    onclick="cancelTryOut('GETapi-v1-rider-credits');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-rider-credits"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/rider/credits</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-rider-credits"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-rider-credits"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-rider-credits"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/rider/referrals/apply" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/referrals/apply';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-rider-referrals-apply">
            <blockquote>
            <p>Example response (200, Referral code applied successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-rider-referrals-apply" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-rider-referrals-apply"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-rider-referrals-apply"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-rider-referrals-apply" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-rider-referrals-apply">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-rider-referrals-apply" data-method="POST"
      data-path="api/v1/rider/referrals/apply"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-rider-referrals-apply', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-rider-referrals-apply"
                    onclick="tryItOut('POSTapi-v1-rider-referrals-apply');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-rider-referrals-apply"
                    onclick="cancelTryOut('POSTapi-v1-rider-referrals-apply');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-rider-referrals-apply"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/rider/referrals/apply</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-rider-referrals-apply"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-rider-referrals-apply"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-rider-referrals-apply"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="referral_code"                data-endpoint="POSTapi-v1-rider-referrals-apply"
               value="ABC12345"
               data-component="body">
    <br>
<p>The referral code from another user. Must not be greater than 12 characters. Example: <code>ABC12345</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/rider/rides/architecto/promo-code" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/rider/rides/architecto/promo-code';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-rider-rides--ride_id--promo-code">
            <blockquote>
            <p>Example response (200, Promo code applied successfully.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (422, Invalid or expired promo code.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-rider-rides--ride_id--promo-code" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-rider-rides--ride_id--promo-code"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-rider-rides--ride_id--promo-code"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-rider-rides--ride_id--promo-code" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-rider-rides--ride_id--promo-code">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-rider-rides--ride_id--promo-code" data-method="POST"
      data-path="api/v1/rider/rides/{ride_id}/promo-code"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-rider-rides--ride_id--promo-code', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-rider-rides--ride_id--promo-code"
                    onclick="tryItOut('POSTapi-v1-rider-rides--ride_id--promo-code');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-rider-rides--ride_id--promo-code"
                    onclick="cancelTryOut('POSTapi-v1-rider-rides--ride_id--promo-code');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-rider-rides--ride_id--promo-code"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/rider/rides/{ride_id}/promo-code</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-rider-rides--ride_id--promo-code"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-rider-rides--ride_id--promo-code"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-rider-rides--ride_id--promo-code"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="POSTapi-v1-rider-rides--ride_id--promo-code"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="POSTapi-v1-rider-rides--ride_id--promo-code"
               value="SUMMER2024"
               data-component="body">
    <br>
<p>The promo code to apply. Must not be greater than 50 characters. Example: <code>SUMMER2024</code></p>
        </div>
        </form>
...
<span id="example-responses-DELETEapi-v1-rider-rides--ride_id--promo-code">
</span>
<span id="execution-results-DELETEapi-v1-rider-rides--ride_id--promo-code" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-rider-rides--ride_id--promo-code"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-rider-rides--ride_id--promo-code"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-rider-rides--ride_id--promo-code" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-rider-rides--ride_id--promo-code">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-rider-rides--ride_id--promo-code" data-method="DELETE"
      data-path="api/v1/rider/rides/{ride_id}/promo-code"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-rider-rides--ride_id--promo-code', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-rider-rides--ride_id--promo-code"
                    onclick="tryItOut('DELETEapi-v1-rider-rides--ride_id--promo-code');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-rider-rides--ride_id--promo-code"
                    onclick="cancelTryOut('DELETEapi-v1-rider-rides--ride_id--promo-code');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-rider-rides--ride_id--promo-code"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-rider-rides--ride_id--promo-code"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-rider-rides--ride_id--promo-code"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-rider-rides--ride_id--promo-code"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ride_id"                data-endpoint="DELETEapi-v1-rider-rides--ride_id--promo-code"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ride. Example: <code>architecto</code></p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/safety/contacts" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/safety/contacts"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/safety/contacts';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-GETapi-v1-safety-contacts">
            <blockquote>
            <p>Example response (200, List of emergency contacts):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Forbidden - User does not have rider/driver role or profile incomplete):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-v1-safety-contacts" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-safety-contacts"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-safety-contacts"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-safety-contacts" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-safety-contacts">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-safety-contacts" data-method="GET"
      data-path="api/v1/safety/contacts"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-safety-contacts', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-safety-contacts"
                    onclick="tryItOut('GETapi-v1-safety-contacts');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-safety-contacts"
                    onclick="cancelTryOut('GETapi-v1-safety-contacts');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-safety-contacts"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/safety/contacts</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-safety-contacts"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-safety-contacts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-safety-contacts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<span id="example-responses-POSTapi-v1-safety-contacts">
            <blockquote>
            <p>Example response (201, Emergency contact added successfully):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-safety-contacts" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-safety-contacts"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-safety-contacts"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-safety-contacts" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-safety-contacts">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-safety-contacts" data-method="POST"
      data-path="api/v1/safety/contacts"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-safety-contacts', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-safety-contacts"
                    onclick="tryItOut('POSTapi-v1-safety-contacts');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-safety-contacts"
                    onclick="cancelTryOut('POSTapi-v1-safety-contacts');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-safety-contacts"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-safety-contacts"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-safety-contacts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-safety-contacts"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-safety-contacts"
               value="John Doe"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-v1-safety-contacts"
               value="+37369123456"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-v1-safety-contacts"
               value="john@example.com"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-v1-safety-contacts" style="display: none">
...
<span id="example-responses-DELETEapi-v1-safety-contacts--id-">
            <blockquote>
            <p>Example response (200, Emergency contact deleted successfully):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (403, Forbidden - Cannot delete another users contact):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-DELETEapi-v1-safety-contacts--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-safety-contacts--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-safety-contacts--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-safety-contacts--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-safety-contacts--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-safety-contacts--id-" data-method="DELETE"
      data-path="api/v1/safety/contacts/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-safety-contacts--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-safety-contacts--id-"
                    onclick="tryItOut('DELETEapi-v1-safety-contacts--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-safety-contacts--id-"
                    onclick="cancelTryOut('DELETEapi-v1-safety-contacts--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-safety-contacts--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-v1-safety-contacts--id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-safety-contacts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-safety-contacts--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-v1-safety-contacts--id-"
               value="architecto"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="contact"                data-endpoint="DELETEapi-v1-safety-contacts--id-"
               value="01HZY2K8J8QK8Z8Z8Z8Z8Z"
               data-component="url">
    <br>
<p>ULID of the emergency contact. Example: <code>01HZY2K8J8QK8Z8Z8Z8Z8Z</code></p>
            </div>
                    </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8080/api/v1/safety/sos" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/safety/sos';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
<span id="example-responses-POSTapi-v1-safety-sos">
            <blockquote>
            <p>Example response (200, SOS alert sent to emergency contacts):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;"></code>
            ...
            <blockquote>
            <p>Example response (400, No emergency contacts found):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-safety-sos" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-safety-sos"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-safety-sos"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-safety-sos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-safety-sos">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-safety-sos" data-method="POST"
      data-path="api/v1/safety/sos"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-safety-sos', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-safety-sos"
                    onclick="tryItOut('POSTapi-v1-safety-sos');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-safety-sos"
                    onclick="cancelTryOut('POSTapi-v1-safety-sos');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-safety-sos"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/safety/sos</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-safety-sos"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-safety-sos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-safety-sos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="latitude"                data-endpoint="POSTapi-v1-safety-sos"
               value="47.0105"
               data-component="body">
    <br>
<p>The current latitude of the user. Must be between -90 and 90. Example: <code>47.0105</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>longitude</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="longitude"                data-endpoint="POSTapi-v1-safety-sos"
               value="28.8638"
               data-component="body">
    <br>
<p>The current longitude of the user. Must be between -180 and 180. Example: <code>28.8638</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>message</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="message"                data-endpoint="POSTapi-v1-safety-sos"
               value="I need help immediately!"
               data-component="body">
    <br>
<p>Optional emergency message. Must not be greater than 500 characters. Example: <code>I need help immediately!</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/support/tickets?per_page=15&amp;filter[status]=architecto&amp;filter[subject]=n&amp;sort=-created_at" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-support-tickets"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter"                data-endpoint="GETapi-v1-support-tickets"
               value=""
               data-component="query">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter.status"                data-endpoint="GETapi-v1-support-tickets"
               value="architecto"
               data-component="query">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="filter.subject"                data-endpoint="GETapi-v1-support-tickets"
               value="n"
               data-component="query">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="sort"                data-endpoint="GETapi-v1-support-tickets"
               value="-created_at"
               data-component="query">
    <br>
<p>Sort field (prefix with - for descending). Supported: created_at, updated_at, status. Example: <code>-created_at</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>created_at</code></li> <li><code>-created_at</code></li> <li><code>updated_at</code></li> <li><code>-updated_at</code></li> <li><code>status</code></li> <li><code>-status</code></li></ul>
            </div>
                </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8080/api/v1/support/tickets/architecto" \
    --header "Authorization: Bearer &amp;lt;token&amp;gt;" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8080/api/v1/support/tickets/architecto"
);
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost:8080/api/v1/support/tickets/architecto';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-support-tickets--id-"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-v1-support-tickets--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ticket. Example: <code>architecto</code></p>
...
<span id="example-responses-POSTapi-v1-support-tickets--ticket_id--comments">
            <blockquote>
            <p>Example response (201, Support ticket comment created successfully.):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-support-tickets--ticket_id--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-support-tickets--ticket_id--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-support-tickets--ticket_id--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-support-tickets--ticket_id--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-support-tickets--ticket_id--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-support-tickets--ticket_id--comments" data-method="POST"
      data-path="api/v1/support/tickets/{ticket_id}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-support-tickets--ticket_id--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-support-tickets--ticket_id--comments"
                    onclick="tryItOut('POSTapi-v1-support-tickets--ticket_id--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-support-tickets--ticket_id--comments"
                    onclick="cancelTryOut('POSTapi-v1-support-tickets--ticket_id--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-support-tickets--ticket_id--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-support-tickets--ticket_id--comments"
               value="Bearer <token>"
               data-component="header">
    <br>
<p>Example: <code>Bearer &lt;token&gt;</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-support-tickets--ticket_id--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-support-tickets--ticket_id--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ticket_id"                data-endpoint="POSTapi-v1-support-tickets--ticket_id--comments"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the ticket. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="message"                data-endpoint="POSTapi-v1-support-tickets--ticket_id--comments"
               value="I have additional details about this issue."
               data-component="body">
    <br>
<p>Comment message for the support ticket. Must not be greater than 5000 characters. Example: <code>I have additional details about this issue.</code></p>
