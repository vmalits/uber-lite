...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "avatar=@/tmp/php5opi60s0p65ncJiLkBb" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'avatar',
                'contents' =&gt; fopen('/tmp/php5opi60s0p65ncJiLkBb', 'r')
            ],
        ],
    ]
);
...
url = 'http://localhost:8080/api/v1/driver/avatar'
files = {
  'avatar': open('/tmp/php5opi60s0p65ncJiLkBb', 'rb')}
headers = {
  'Authorization': 'Bearer &amp;lt;token&amp;gt;',
  'Content-Type': 'multipart/form-data',
  'Accept': 'application/json'
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Avatar image (jpg, png, webp, max 2MB). Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/php5opi60s0p65ncJiLkBb</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"destination_lat\": 47.0225,
    \"destination_lng\": 28.8353,
    \"scheduled_at\": \"2026-02-23 15:32:09\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="2026-02-23 15:32:09"
               data-component="body">
    <br>
<p>The date and time when the ride is scheduled to start. Must be a valid date. Must be a date after <code>now</code>. Example: <code>2026-02-23 15:32:09</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "avatar=@/tmp/phpjblj8do4i7l20iIhjbP" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'avatar',
                'contents' =&gt; fopen('/tmp/phpjblj8do4i7l20iIhjbP', 'r')
            ],
        ],
    ]
);
...
url = 'http://localhost:8080/api/v1/rider/avatar'
files = {
  'avatar': open('/tmp/phpjblj8do4i7l20iIhjbP', 'rb')}
headers = {
  'Authorization': 'Bearer &amp;lt;token&amp;gt;',
  'Content-Type': 'multipart/form-data',
  'Accept': 'application/json'
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Avatar image (jpg, png, webp, max 2MB). Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpjblj8do4i7l20iIhjbP</code></p>
        </div>
        </form>
