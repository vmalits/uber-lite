...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "avatar=@/tmp/php7ufu57r3fn5tcfeIFjA" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'avatar',
                'contents' =&gt; fopen('/tmp/php7ufu57r3fn5tcfeIFjA', 'r')
            ],
        ],
    ]
);
...
url = 'http://localhost:8080/api/v1/driver/avatar'
files = {
  'avatar': open('/tmp/php7ufu57r3fn5tcfeIFjA', 'rb')}
headers = {
  'Authorization': 'Bearer &amp;lt;token&amp;gt;',
  'Content-Type': 'multipart/form-data',
  'Accept': 'application/json'
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Avatar image (jpg, png, webp, max 2MB). Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/php7ufu57r3fn5tcfeIFjA</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "avatar=@/tmp/phpb7j15i2k70m4dJNEopp" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'avatar',
                'contents' =&gt; fopen('/tmp/phpb7j15i2k70m4dJNEopp', 'r')
            ],
        ],
    ]
);
...
url = 'http://localhost:8080/api/v1/rider/avatar'
files = {
  'avatar': open('/tmp/phpb7j15i2k70m4dJNEopp', 'rb')}
headers = {
  'Authorization': 'Bearer &amp;lt;token&amp;gt;',
  'Content-Type': 'multipart/form-data',
  'Accept': 'application/json'
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Avatar image (jpg, png, webp, max 2MB). Must be an image. Must not be greater than 2048 kilobytes. Example: <code>/tmp/phpb7j15i2k70m4dJNEopp</code></p>
        </div>
        </form>
